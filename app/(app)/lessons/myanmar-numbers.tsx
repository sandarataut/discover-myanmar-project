...
import useNumberViewModel from "viewmodel/NumberViewModel";

export default function MyanmarNumberView() {
  const { lessons, loading, checkIfLessonCompleted } = useNumberViewModel();
  ...
  return (
    <SafeAreaView
      ...
      <Stack.Screen options={{ headerTitle: "Myanmar Numbers" }} />
      <FlatList
